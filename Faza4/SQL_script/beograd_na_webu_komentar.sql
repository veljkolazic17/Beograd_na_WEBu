...
CREATE TABLE `komentar` (
  ...
  CONSTRAINT `idsmestaj_komentar_fk` FOREIGN KEY (`idsmestaj`) REFERENCES `smestaj` (`idsmestaj`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2022-04-16 13:46:58
